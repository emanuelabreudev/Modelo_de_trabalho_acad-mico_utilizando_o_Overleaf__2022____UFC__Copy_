...
\autor{Emanuel de Abreu Barbosa}
\titulo{Uma Síntese Empírica do Método USARP: Percepção, Aplicação e Desafios em Contextos Acadêmicos e Industriais}
\data{2026}
\local{Russas}
...
\orientador{Prof. Ms. Hugo Nathan Barbosa Régis}
\orientadories{Universidade Federal do Ceará (UFC)}
\orientadorcentro{Campus de Russas}
...
\membrodabancadois{Profa. Dra. Anna Beatriz dos Santos Marques}
\membrodabancadoiscentro{Universidade Federal do Ceará - UFC}
\membrodabancadoisies{Universidade Federal do Ceará - UFC}
\membrodabancatres{Profa. Ms. Valéria Maria da Silva Pinheiro}
\membrodabancatrescentro{Universidade Federal do Ceará - UFC}
...
% --- Fallback seguro caso \imprimirpaginaapendices não exista ---
% \makeatletter
% \providecommand{\imprimirpaginaapendices}{%
%   \clearpage % ou \cleardoublepage se preferir começar em página ímpar
%   \phantomsection
